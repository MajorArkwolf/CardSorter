...
//#define remote_ip IPAddress(192, 168, 128, 10)
// *** REMOTE HOST IS NOT YET WORKING ***
// replace with hostname of server you want to connect to, comment out if using 'remote_ip'
//#define remote_host "arduino1.local"
...
#define local_ip IPAddress(192, 168, 128, 11)

// STEP 5 [REQUIRED]
// replace with ethernet shield mac. Must be unique for your network
const byte mac[] = {0x90, 0xA2, 0xDA, 0x00, 0x53, 0xED};
